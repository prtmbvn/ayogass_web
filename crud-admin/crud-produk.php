            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT*FROM produk"; //"SELECT*FROM pesanan ORDER BY id_pesanan DESC";
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <th scope='row'class='align-middle'>" . $id_produk . "</th>
                                <th scope='row'class='align-middle'>" . $nama_produk . "</th>
                                <th scope='row'class='align-middle'>" . $harga_produk . "</th>                                                              
                                <th scope='row' class='act'>
                                <a href='update-produk.php?id=$id_produk'><button type='submit' name='upd' class='btn btn-success'>Edit</button></a><br>
                                <!--<a href='crud-agen.php?act=hapus&id=$id_produk'><button type='submit' onclick=\"return confirm('Hapus Data Pesanan ?')\" class='btn btn-danger'>Delete</button></a><br>-->
